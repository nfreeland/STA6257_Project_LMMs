...
-home advantage random effect approaches zero
  - no additional change in EPA per play due to home field advantage 
-additional 0.02 EPA per play due to coaching
...
- there's consistency with how often coaches throw the ball
-variation in number of shotgun snaps an offense runs is much wider
...
- no statistical significance between the models 
-the effect of home field advantage is minimal to zero
