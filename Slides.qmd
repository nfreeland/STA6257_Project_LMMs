...
-   Fixed effects show average trends for the population
-   Random effects show how trends vary across groups
    -   explains error due to differences between groups

<!-- include examples of fixed and random effects -->
...
<!-- show comparisons of sample graphs and models -->
