...
[Link to presentation](https://beg18uwf.github.io/STA6257_Project_LMMs/Slides)
...
#replace this section with histograms (or other viz) for numerical data
...
|:-----------------|--------|-------------|-------------|-----------|-------------|---------|
| week         | 1.000    |   5.000    |   10.000    |   9.958    |   15.000       |   22.000      |
| season_type              | 0.00000      |   0.00000     |   0.00000      |   0.04561      |   3rd Qu    |   1.00000     |
| Variable         | Min    |   1st Qu    |   Median    |   Mean    |   3rd Qu    |   Max   |
| Variable         | Min    |   1st Qu    |   Median    |   Mean    |   3rd Qu    |   Max   |
| Variable         | Min    |   1st Qu    |   Median    |   Mean    |   3rd Qu    |   Max   |
| Variable         | Min    |   1st Qu    |   Median    |   Mean    |   3rd Qu    |   Max   |
